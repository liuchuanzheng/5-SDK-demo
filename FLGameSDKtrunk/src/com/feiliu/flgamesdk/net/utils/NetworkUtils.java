...
import com.feiliu.flgamesdk.utils.ShellUtils;
...
public class NetworkUtils {
    ...
    public static boolean isAvailableByPing(Context context) {
        ...
        if (result.errorMsg != null) {
        	MyLogger.lczLog().i("isAvailableByPing errorMsg: "+result.errorMsg);
        }
        if (result.successMsg != null) {
        	MyLogger.lczLog().i("isAvailableByPing successMsg: "+result.successMsg);
        }
        return ret;
    }
