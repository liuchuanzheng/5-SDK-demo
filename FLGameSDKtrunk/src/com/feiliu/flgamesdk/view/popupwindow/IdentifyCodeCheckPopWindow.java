 ...
 *
 */
public class IdentifyCodeCheckPopWindow extends BasePopWindow implements  OnDismissListener, BaseBarListener {
	...
	public IdentifyCodeCheckPopWindow(Context context, String accountString,
		...
		//联网发送验证码
		SendIdenfyCodeRequest sendidenfyCodeRequest = new SendIdenfyCodeRequest(context, loginListener, IdentifyCodeCheckPopWindow.this
				, accountString);
		...
		yesView.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				CheckIdenfyCodeRequest checkIdenfyCodeRequest = new CheckIdenfyCodeRequest(context, loginListener
						, IdentifyCodeCheckPopWindow.this,null, accountString, code,"IdentifyCodeCheckPopWindow");
	...
	public void showWindow() {
		MyLogger.lczLog().i("展示：IdentifyCodeCheckPopWindow");
		new Runnable() {
			@Override
			public void run() {
				TextView tv;
