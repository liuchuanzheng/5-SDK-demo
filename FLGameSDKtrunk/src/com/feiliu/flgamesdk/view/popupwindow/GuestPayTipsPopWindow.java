 ...
 * 
 */
public class GuestPayTipsPopWindow extends BasePopWindow implements
	...
	public GuestPayTipsPopWindow(Context context, Boolean haveGestLogin,
			String giftStatus, String password, FLOnLoginListener loginListener,OnDismissListener onDismissListener) {
	...
	public View createMyUi() {
		...
		changelessTipsView.setText("当前账号安全性较差！请尽快绑定手机或邮箱升级为正式账号。\n绑定后可使用手机或邮箱进行登录及找回密码。");
