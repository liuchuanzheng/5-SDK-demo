...
import com.feiliu.flgamesdk.net.request.BindRequest;
 ...
 *
 */
public class BindPasswordPopWindow extends BasePopWindow implements  OnDismissListener, BaseBarListener {
	 ...
	 */
	public BindPasswordPopWindow(Context context, AccountDBBean accountDBBean, String accountString,String code,
	...
	public View createMyUi() {
		...
		yesView.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				BindRequest bindRequest = new BindRequest(context, loginListener, BindPasswordPopWindow.this, accountString, code,passWord, accountDBBean);
				bindRequest.post();
			}
		});
	...
	public void showWindow() {
		MyLogger.lczLog().i("展示：BindPasswordPopWindow");
		new Runnable() {
			@Override
			public void run() {
				TextView tv;
