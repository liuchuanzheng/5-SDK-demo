 ...
 *
 */
public class BindIdenfyCodePopWindow extends BasePopWindow implements  OnDismissListener, BaseBarListener {
	...
	public BindIdenfyCodePopWindow(Context context, AccountDBBean accountDBBean, String accountString,
		...
		//联网发送验证码
		SendIdenfyCodeRequest sendidenfyCodeRequest = new SendIdenfyCodeRequest(context, loginListener, BindIdenfyCodePopWindow.this
				, accountString);
	...
	public View createMyUi() {
		...
		BaseBarView baseBarView = new BaseBarView(context, tips, true,false, this);
		...
		yesView.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				CheckIdenfyCodeRequest checkIdenfyCodeRequest = new CheckIdenfyCodeRequest(context, loginListener
						, BindIdenfyCodePopWindow.this, accountDBBean,accountString, code,"BindIdenfyCodePopWindow");
	...
	public void showWindow() {
		MyLogger.lczLog().i("展示：BindIdenfyCodePopWindow");
		new Runnable() {
			@Override
			public void run() {
				TextView tv;
